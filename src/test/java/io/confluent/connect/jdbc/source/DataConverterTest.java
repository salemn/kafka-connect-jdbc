...
public class DataConverterTest {
    ...
    private static DatabaseMetaData mockDatabaseMetaData() throws SQLException {
        DatabaseMetaData metadata = mock(DatabaseMetaData.class);
        ResultSet resultSet = mock(ResultSet.class);
        when(resultSet.getString(anyString())).thenReturn("");
        when(metadata.getColumns(anyString(),anyString(),anyString(),anyString())).thenReturn(resultSet);
        return metadata;
    }
    ...
    public void numericIsMappedByPrecisionViaFlag() throws SQLException {
        DatabaseMetaData dbmetadata = mockDatabaseMetaData();
        ...
        Schema schema = new DataConverter(config).convertSchema("mock", metadata, dbmetadata, "");
